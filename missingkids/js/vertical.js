/**
 * NCMEC/MissingKids.com vertical javascript banner v1.0
...
function populateNCMECContainerInitially() {
    ...
    var containerContents="<div class='banner-header'>";        
    containerContents+="<div><a id='ncmec_help_me_link' target='_blank'>Help Me To Get Back Home</a></div>";
    containerContents+="<div><a href='http://missingkids.com'><img id='ncmec_logo' alt='National Center For Missing and Exploited Children' title='National Center For Missing and Exploited Children' src='"+ncmecImagesRootUrl+"MK_logo-240x400.png'></a></div>";        
    containerContents+="<div id='ncmec_call_text'>Call 1-800-THE-LOST</div>";
    containerContents+="</div>"; 
    containerContents+="<div class='banner-body'>";
    ...
    containerContents+="<a id='ncmec_child_photo_link' target='_blank'>";        
    containerContents+="<a id='ncmec_child_info_link' target='_blank'><div id='ncmec_child_info'>&nbsp; <br/>&nbsp; <br/>&nbsp; <br/></div></a>";            
    ...
    containerContents+="</div> "; 
    containerContents+="<div id='ncmec_click_photo_text'>Click on the photo for more information</div>";
    containerContents+="</div> ";                   
...
function updateNCMECDisplayWithObject(which) {   
    ...
    //links
    document.getElementById('ncmec_child_photo_link').href = ncmecObject.link;
...
function ncmecFeedLoaded(result) {
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      //if name is LONG, split it on two lines
      //if (name.length > 16) {
      ...
      missingDate = "Missing since: <strong>"+missingDate+"</strong>";
